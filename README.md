<h1 align="center">Whaticket Baileys |AME Zap</h1>
...
```bash
sudo apt install -y git && git clone https://github.com/equinhone/whaticket_crmame_install install && sudo chmod -R 777 ./install && cd ./install && sudo ./install_primaria
```
